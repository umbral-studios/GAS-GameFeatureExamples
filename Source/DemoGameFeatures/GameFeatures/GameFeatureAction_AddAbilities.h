...
struct FDemoGameFeaturesAbilityMapping
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FDemoGameFeaturesAttributesMapping
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSoftClassPtr<UDemoGameFeaturesAbilityAttributeSet> AttributeSetType;
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FDemoGameFeaturesAbilityMapping> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FDemoGameFeaturesAttributesMapping> GrantedAttributes;
};
